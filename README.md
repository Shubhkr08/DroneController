...
- MPU9250.(IMU) for statbility and orientation of board/vehicle.
- BMP280 .(Barometer) barometer for altitude calculations . helps to hover the flight.

- ## Bill of Materials (BOM)
| Serial Num | Description | Total (USD) | 
|----:|--------------------------|-------------|
| 1  | PCB and Assembly  |121.46 |
...
# 3d Render<br>
<img width="636" height="960" alt="Screenshot (245)" src="https://github.com/user-attachments/assets/886fc03b-3b96-4014-ac86-9d4a4a347cb9" /><br>
...
<img width="998" height="756" alt="Screenshot (243)" src="https://github.com/user-attachments/assets/536bc7d5-b37d-4e45-bd6f-39ff4773a1b9" />
  <br>
